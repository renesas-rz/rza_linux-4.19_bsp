...
static d2_s32 d2_renderwedge_intern( d2_devicedata *handle, d2_contextdata *ctx, d2_point x, d2_point y, d2_width r, d2_width w, d2_s32 nx1, d2_s32 ny1, d2_s32 nx2, d2_s32 ny2, d2_u32 flags )
{
   ...
   (void)d2_setclipgradient( handle, 0, x, y, nx1, ny1, 
                             ...
                             d2_grad_offset                                             |
                             ((0 != (flags & d2_wf_concave))   ? d2_grad_concave   : 0));
   ...
   { 
      ...
      {
         bxmin = (d2_border)(D2_INT4(x - (D2_FIX4(1) >> 1)));  /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
      }
      ...
      {
         bxmax = (d2_border)(D2_INT4(x + (D2_FIX4(1) >> 1)));  /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
      }
      ...
      {
         bymax = (d2_border)(D2_INT4(y + (D2_FIX4(1) >> 1)));  /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
      }
      ...
      {
         bymin = (d2_border)(D2_INT4(y - (D2_FIX4(1) >> 1)));  /* PRQA S 0502 */ /* $Misra: #PERF_ARITHMETIC_SHIFT_RIGHT $*/
      }
