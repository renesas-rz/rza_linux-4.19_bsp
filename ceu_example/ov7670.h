...
#define   COM13_UVSWAP	  0x02	  /* V before U - w/TSLB */
...
#define REG_MANU	0x67	/* U value when testing */
#define REG_MANV	0x68	/* V value when testing */
...
void ov7670_print_registers(void);
 ...
 #define CAM_FMT_RGB444 1
 #define CAM_FMT_RGB565 2
 #define CAM_FMT_RAW 3
#endif
